...
class ppu2c02: public busDevice<uint8_t, uint16_t>, public LTE::component 
{
    ...
    public:
        ppu2c02(ppuBusCartridge *cartridge)
        {
            ...
            ppuBus.pushDevice(cartridge)->
                   pushDevice(new nameTable())->
                   pushDevice(new palettesMemory());
        }
        ...
        virtual uint8_t read(uint16_t addr, bool bReadOnly = false) override
        {
            ...
            LAUGHTALE_ENGINR_LOG_INFO("addr: " << (int)addr << ", " << (int) data)
            return data;
        }
        ...
        virtual void write(uint16_t addr, uint8_t data) override
        {
            ...
            LAUGHTALE_ENGINR_LOG_INFO("write addr: " << (int)addr << ", " << (int)data )
        }
